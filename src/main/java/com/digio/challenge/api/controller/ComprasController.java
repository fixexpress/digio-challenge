...
public class ComprasController {
	...
	public List<ComprasDTO> getCompras() {
		...
		if (clientes == null) {
			throw new IllegalStateException("Os clientes e suas compras não foram carregadas no cache.");
		}
 ...
 * Retornar uma recomenda��o de vinho baseado nos tipos de vinho que o cliente mais compra. 
 */
